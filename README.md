...
Tokens are are used for authentication and access. They are encrypted strings of text.

2. What steps can you take in your web apps to keep your data secure?

You can use tokens to authenicate and private routes to allow access to authenticated users.

3. Describe how web servers work.

A web server stores the code for different apps/websites and also runs the code to retreive the app code.
